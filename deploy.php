...
// ---------------------------------------------------------------------------
set("env_database", "mysql://wildchallenge:wildchallenge@127.0.0.1:3306/wildchallenge?serverVersion=mariadb-10.3.25&charset=utf8mb4");
...
// TODO 
set('remote_server_url','ali0908-server.eddi.cloud');
...
// TODO
set('remote_server_target_repository', '/var/www/html/Projects/wildchallenge/');

// Adresse du dépôt Github contenant le code source du projet 
// TODO
set('repository', 'git@github.com:Ali0908/wildchallenge.git');
...
task('first_deploy', [
    ...
    // notre commande développée en cours
    // 'kustom:command:poster',
